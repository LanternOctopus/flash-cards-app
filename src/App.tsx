...
import ReadOutLoud from "./components/ReadOutLoud";
import SpeechGuesser from "./components/SpeechGuesser";
const App: React.FC = () => {
    return (
        <div>
            <nav>
        ...
        <Link to="/contact">Contact</Link> */}
                |{" "}
                <Link to="/readoutloud">Read Out Loud</Link>
                |{" "}
                <Link to="/speechguesser">
                    Speech Guesser
                </Link>
            </nav>
