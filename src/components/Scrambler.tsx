...
const Scrambler: FC = () => {
  ...
  const LearningHint: React.FC = () => {
      return <div><p>{"Present tense: I am, You are, It is, She is, He is, They are, We are."}</p> <p> {"Past tense: I was, You were, It was, She was, He was, They were, We were."} </p><p>{" Future tense: I will be, You will be, It will be, She will be, He will be, They will be, We will be."}</p></div>;
    };
